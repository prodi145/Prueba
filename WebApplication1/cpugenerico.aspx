...
<body>
	...
	<div class="main-container">
		...
		<div>
            ...
            <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="X-Large" Text="CPU GENERICO"></asp:Label>
            <br />
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <br />
            <br />
            <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Ver Tipo CPU" />
            <br />
            ...
            <br />
            <br />
            <asp:Button ID="Button2" runat="server" Text="Ver Marcas" OnClick="Button2_Click" />
            <br />
            ...
            <br />
            <br />
            <asp:Button ID="Button3" runat="server" Text="Ver Ram" OnClick="Button3_Click" />
            <br />
            ...
            <br />
            <asp:Button ID="Button4" runat="server" Text="Ver Gabinete" OnClick="Button4_Click" />
            <br />
            <br />
...
&nbsp;<asp:FileUpload ID="FileUpload1" runat="server" />
            <asp:Image ID="Image1" runat="server" Height="113px" Width="148px" />
&nbsp;
            <br />
            <asp:Button ID="Button5" runat="server" OnClick="Button5_Click1" Text="Guardar" />
&nbsp;&nbsp;
...
&nbsp;
            <asp:Button ID="Button9" runat="server" OnClick="Button9_Click" Text="Eliminar Cpu" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="Button10" runat="server" OnClick="Button10_Click" Text="Ver imagen" />
            <br />
            <br />
            <br />
            <asp:GridView ID="GridView5" runat="server" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" CellPadding="2" ForeColor="Black" GridLines="None" OnSelectedIndexChanged="GridView5_SelectedIndexChanged">
