...
&nbsp;<br />
            ...
            <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None">
                ...
                <Columns>
                    <asp:CommandField ButtonType="Button" HeaderText="Salecciona" ShowSelectButton="True" />
                </Columns>
...
&nbsp;&nbsp;
            <asp:Button ID="Button3" runat="server" Text="Editar" OnClick="Button3_Click" style="height: 26px" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="Button6" runat="server" OnClick="Button6_Click" style="height: 26px" Text="Guardar Cambios" />
&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="Button4" runat="server" Text="Eliminar" OnClick="Button4_Click" />
            <br />
            <br />
            <asp:Button ID="Button2" runat="server" Text="Ver Datos" OnClick="Button2_Click" style="height: 26px" />
            <br />
            <br />
