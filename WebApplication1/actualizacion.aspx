...
<body>
	...
	<div class="main-container">
		 <div>
            <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="X-Large" Text="Actualizacion"></asp:Label>
            <br />
            <br />
            <asp:TextBox ID="TextBox3" runat="server" Enabled="False" Height="21px" Width="183px"></asp:TextBox>
&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="TextBox4" runat="server" Enabled="False" Visible="False"></asp:TextBox>
            <br />
            <br />
            <br />
            Selecciona un inventario: <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Ver inventarios" />
            ...
            <br />
            Numero de Serie: <asp:TextBox ID="TextBox1" runat="server" OnTextChanged="TextBox1_TextChanged"></asp:TextBox>
            <br />
            <br />
            Descripción:
...
&nbsp;
            <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" Text="Ver Datos" />
&nbsp;
            <asp:Button ID="Button4" runat="server" OnClick="Button4_Click" Text="Editar" />
&nbsp;
            <asp:Button ID="Button5" runat="server" OnClick="Button5_Click" Text="Guardar Cambios" />
&nbsp;
            ...
            <asp:GridView ID="GridView2" runat="server" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4">
                <Columns>
                    <asp:CommandField ButtonType="Button" HeaderText="Selecionar" ShowSelectButton="True" />
                </Columns>
